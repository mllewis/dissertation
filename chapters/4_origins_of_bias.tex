...
This thus provides some tentative evidence consistent with the Learning Hypothesis: Children  While we did not observe the bias in the younger children in our sample, there are many possible reasons for this failure Nevertheless, it is puzzling

%%%%%%%%STUDY 2b - CDI%%%%%%%%
\section{Study 2b: The role of complexity in  language acquisition}
In Study 2a, we find, consistent with the Learning Hypothesis,  that a complexity bias may play a role in the acquisition of new words. In Study 2b, we explore a two additional predictions of the Learning Hypothesis:  (1) Children's early vocabulary should contain a complexity bias, and (2) the conceptual complexity of a word's meaning should influence the ease with which words are learned. In particular, we predict that, if conceptual complexity is relevant in acquisition, then children should tend to acquire words with simpler meanings before those with more complex meanings.
