...
In  Chapters 2-4, we  explored a particular regularity in the lexicon of natural languages---a complexity bias---as a case study in the role of dynamics at shorter timescales in shaping language structure. The focus of Chapter 4 was to provide an explanation for the historical origin of this bias. The evidence from this chapter points most favorably towards accounts relying on a cognitive pressures, namely a bias toward iconicity, that influence both word learning in language acquisition and memory errors in speakers  potentially across development. In the present chapter, we extend this work by asking how a broader range of pressures in the environmental context might influence a broader range of regularities in language. This wider view of the empirical landscape is particularly important because there may be relevants  trade-offs and dynamics between different environmental pressures, as well between different regularities in language. The central goal of Chapter 5 is thus to describe this empirical landscape.\footnote{This chapter is published in Lewis, M. \& Frank, M. C. (2016). Linguistic niches emerge from pressures at multiple timescales. Proceedings of the 38th Annual Meeting of the Cognitive Science Society. Austin, TX: Cognitive Science Society.}
